...
cd swig/
git checkout d9875c6579efc8a56132313704c69e627c990dac
./autogen.sh
...
export PATH=$BI/bin:$PATH
export SWIG_LIB=$BI/share/swig/3.0.10/
...
cd GenomicConsensus
git checkout 5d77df429567ccef73b8435e439fea052d325604
