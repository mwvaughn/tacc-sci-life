...
%define shortsummary The Genome Analysis ToolKit is used to to analyze high-throughput sequencing data
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name gatk
...
Source:    GenomeAnalysisTK-%{major_version}.%{minor_version}-%{patch_version}.tar.bz2
...
%setup -n GenomeAnalysisTK-%{major_version}.%{minor_version}-%{patch_version}-ge9d806836
...
cp GenomeAnalysisTK.jar $RPM_BUILD_ROOT/%{INSTALL_DIR}
