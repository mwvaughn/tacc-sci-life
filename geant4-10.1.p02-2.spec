...
# NOTE: this is an old version, do not install it on ls5
%if "%{PLATFORM}" == "ls5"
...
mkdir %{PNAME}.10.01.p02/ # the clean script will complain if this is not here
mkdir %{PNAME}-%{version}/
...
"cmake -DGEANT4_DIR=$TACC_GEANT4_DIR/lib64/Geant4-10.1.2  /path/to/code/"
...
# In SPECS dir:
# ./build_rpm.sh --gcc=49 geant4-10.1.p02-2.spec
#
# In apps dir: 
