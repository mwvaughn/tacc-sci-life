...
Source:       http://downloads.sourceforge.net/project/bowtie-bio/bowtie2/2.2.6/bowtie2-2.2.6-source.zip
...
%if "%{PLATFORM}" == "ls5" 
make EXTRA_FLAGS="-march=sandybridge -mtune=haswell -Wl,-rpath,$GCC_LIB" 
%else
