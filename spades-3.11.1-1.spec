...
%define shortsummary SPAdes - St. Petersburg genome assembler
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name spades
...
Source:    http://cab.spbu.ru/files/release%{pkg_version}/SPAdes-%{pkg_version}.tar.gz
...
##################################
module purge
module load TACC gcc cmake boost
##################################
...
cmake -G "Unix Makefiles" -DSPADES_STATIC_BUILD=ON -DSPADES_BOOST_ROOT="${TACC_BOOST_DIR}" -DCMAKE_INSTALL_PREFIX="$PREFIX" $* "$BASEDIR/src"
make -j 8
make install
