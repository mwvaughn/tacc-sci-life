...
Source:    http://ftp-trace.ncbi.nlm.nih.gov/sra/sdk/%{major_version}.%{minor_version}.%{patch_version}/%{pkg_base_name}.%{major_version}.%{minor_version}.%{patch_version}-centos_linux64.tar.gz
...
%setup -n %{pkg_base_name}.%{major_version}.%{minor_version}.%{patch_version}-centos_linux64
