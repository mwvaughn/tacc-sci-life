...
%define shortsummary A set of scripts to help launch jobs at TACC
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name helper
...
URL:       https://github.com/zyndagj/launcher_helpers
...
git clone https://github.com/zyndagj/launcher_helpers.git
cp -r launcher_helpers/* $RPM_BUILD_ROOT/%{INSTALL_DIR}/
rm -rf launcher_helpers
