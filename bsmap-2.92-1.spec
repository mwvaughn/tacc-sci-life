...
%define shortsummary BSMAP for Methylation
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name bsmap
...
URL:       https://code.google.com/p/bsmap
...
cd BSMAP && git checkout multicore
