...
%define shortsummary A quality control tool for high throughput sequence data
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name fastqc
...
Source:    https://www.bioinformatics.babraham.ac.uk/projects/fastqc/%{pkg_base_name}_v%{pkg_version}.zip
