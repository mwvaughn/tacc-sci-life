...
%define shortsummary Jim Kent command line bioinformatic utilities
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name kentUtils

# Create some macros (spec file variables)
%define major_version 302
...
whatis("Keywords: Biology, Genomics, UCSC, genome browser")
