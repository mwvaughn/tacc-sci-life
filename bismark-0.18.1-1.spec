...
%define shortsummary Bismark is a program to map bisulfite treated sequencing reads to a genome of interest and perform methylation calls in a single step
Summary: %{shortsummary}

# Give the package a base name
%define pkg_base_name bismark
...
Source:    https://www.bioinformatics.babraham.ac.uk/projects/bismark/%{pkg_base_name}_v%{major_version}.%{minor_version}.%{patch_version}.tar.gz
%package %{PACKAGE}
Summary: %{shortsummary}
Group:   Applications/Life Sciences
%description package
...
%setup -n %{pkg_base_name}_v%{major_version}.%{minor_version}.%{patch_version}
